  ...
  render() {
    return (
      ...
      if(this.state.search == null)
          return result
      else if(result.name.toLowerCase().includes(this.state.search.toLowerCase()) ||        result.des.toLowerCase().includes(this.state.search.toLowerCase())  ||        result.price <1000){
          return result
      }
    }).map((result,index) => {
              return (
